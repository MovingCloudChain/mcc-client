...
var mcc = require("../index.js");

describe("MCC JS", function () {
	...
	it("should have properties", function () {
		...
		properties.forEach(function (property) {
			(mcc).should.have.property(property);
		});
	});

	describe("crypto.js", function () {
		var crypto = mcc.crypto;
	...
	describe("dapp.js", function () {
		...
		describe("#createDapp", function () {
			...
			describe("returned dapp", function () {
				var keys = mcc.crypto.getKeys("secret");
				var secondKeys = mcc.crypto.getKeys("secret 2");
				...
				it("should be signed correctly", function () {
					var result = mcc.crypto.verify(trs);
					(result).should.be.ok;
				});
				...
				it("should be second signed correctly", function () {
					trs.amount = 0;
					var result = mcc.crypto.verifySecondSignature(trs, secondKeys.publicKey);
					(result).should.be.ok;
				});
	...
	describe("delegate.js", function () {
		...
		describe("#createDelegate", function () {
			...
			describe("returned delegate", function () {
				...
				it("should be signed correctly", function () {
					var result = mcc.crypto.verify(trs, keys.publicKey);
					(result).should.be.ok;
				});
				...
				it("should not be second signed correctly now", function () {
					trs.amount = 100;
					var result = mcc.crypto.verify(trs, secondKeys.publicKey);
					(result).should.be.not.ok;
				});
	...
	describe("transaction.js", function () {
		var transaction = mcc.transaction;
		...
		describe("#createTransaction with second secret", function () {
			...
			var keys = mcc.crypto.getKeys(secondSecret);
			...
			describe("returned transaction", function () {
				...
				it("should be second signed correctly", function () {
					var result = mcc.crypto.verifySecondSignature(trs, keys.publicKey);
					(result).should.be.ok;
				});
	...
	describe("vote.js", function () {
		...
		describe("#createVote", function () {
			var createVote = vote.createVote,
				vt = null,
				publicKey = mcc.crypto.getKeys("secret").publicKey,
			...
			describe("returned vote", function () {
				...
				it("should be signed correctly", function () {
					var result = mcc.crypto.verify(vt);
					(result).should.be.ok;
				});

				it("should be second signed correctly", function () {
					var result = mcc.crypto.verifySecondSignature(vt, mcc.crypto.getKeys("second secret").publicKey);
					(result).should.be.ok;
				});
