 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from Mcc.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from Mcc.
 */
 ...
 * @param error - Error of api call execution.
 * @param response - Response of api call execution.
 * @param response.fees - Amount of Mcc that delegate forged.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from Mcc.
 */
