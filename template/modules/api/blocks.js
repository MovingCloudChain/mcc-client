 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from Mcc.
 */
