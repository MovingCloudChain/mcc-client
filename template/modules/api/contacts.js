 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from Mcc
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from Mcc.
 */
