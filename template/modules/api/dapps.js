 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from Mcc.
 */
 ...
 * @param cb - Callback handles response from Mcc.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from Mcc.
 */
