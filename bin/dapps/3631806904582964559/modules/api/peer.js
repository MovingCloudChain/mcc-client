 ...
 * @param {Peer~getPeersCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Peer~getPeerCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Peer~versionCallback} cb - Callback handles response from Mcc.
 */
