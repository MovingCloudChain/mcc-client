 ...
 * @param {Transactions~getTransactionsCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Transactions~getTransaction} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Transactions~getUnconfirmedTransaction} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Transactions~getUnconfirmedTransactions} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Transactions~addTransactionsCallback} cb - Callback handles response from Mcc.
 */
