 ...
 * @param {Sql~selectCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Sql~insertCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Sql~batchCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Sql~updateCallback} cb - Callback handles response from Mcc.
 */
 ...
 * @param {Sql~removeCallback} cb - Callback handles response from Mcc.
 */
